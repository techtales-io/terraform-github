...
resource "github_branch_protection" "default" {
  ...
  require_signed_commits          = var.branch_protections[github_branch_default.repo.branch].require_signed_commits #trivy:ignore:AVD-GIT-0004 #trivy:ignore:AVD-GIT-0004
